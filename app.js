...
// khai bao thong tin sessio, cookie
app.use(session({
  secret:'i love you', // khoa bi mat
  resave:true,
...
app.use(cors({
  origin:['http://localhost:3000http:'],
  methods:['GET', 'POST', 'PUT', 'DELETE'],
  credentials:true
}))

mongoose.connect('mongodb://127.0.0.1:27017/test02?readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false', {
